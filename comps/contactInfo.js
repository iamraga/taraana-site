...
export default function ContactInfo() {
    return (
        <>
            <div className="contact-detail d-flex flex-row flex-md-row align-items-center align-items-md-normal mb-3">
            ...
            <div className="contact-detail d-flex flex-row flex-md-row align-items-center align-items-md-normal mb-3">
                ...
                <p className="mb-0">Tel: <a href="tel:04443129199"> 044- 4312 9199</a>
