    ...
    return (
        <>
            <ul className="taraana-courses-ul pl-0 mx-auto">
                ...
                {/* <li className="taraana-courses-ul-item d-flex flex-column flex-lg-row align-items-lg-center">
                    <div className="img-section mr-lg-5"><img src="./assets/icons/spotlogo/3.png" alt="course-image" className="img-fluid" /></div>
                    <div className="desc-section">
                        <h3>Tabla/Sitar:</h3>
                ...
                <li className="taraana-courses-ul-item d-flex flex-column flex-lg-row align-items-lg-center">
                    ...
                    <div className="desc-section">
                        <h3>Yoga:</h3>
                        <p className="mb-0">Yoga for dance specifically is an integral part of our regular classes. In addition, we have yoga courses for those who may be interested in it.</p>
                    </div>
                </li>
            </ul>
        </>
